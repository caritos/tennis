...
-- Similar to challenge notifications but for match invitations ("Looking to Play")
...
-- Test the function with a real invitation (replace with actual IDs when testing)
-- SELECT create_match_invitation_notifications(
--     'some-invitation-id'::uuid,
--     'match_confirmed',
--     'some-participant-user-id'::uuid
-- ) as test_result;