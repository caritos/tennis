-- Production function to reliably fetch club match invitations
-- This function bypasses potential RLS issues and provides consistent results
...
BEGIN
  ...
  -- Return match invitations with all related data
  RETURN QUERY
  SELECT 
    mi.id,
    mi.club_id,
