-- Create Working RLS Policy for Notifications - FIXED TYPE CASTING
...
-- Create a working INSERT policy with FIXED type casting
CREATE POLICY "notifications_insert" ON public.notifications
FOR INSERT WITH CHECK (
    -- Allow users to create their own notifications
    auth.uid() = user_id
    OR
    -- Allow challenge notifications with PROPER type casting
    (
        type = 'challenge' 
